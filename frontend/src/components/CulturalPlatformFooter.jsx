    ...
    <footer className="bg-[#d32f2f]  text-white pt-8 pb-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-white/20 pb-8">
          <div className="col-span-full md:col-span-1">
            <h3 className="text-xl font-bold mb-2">
              <span className="block leading-tight">🎵गीतसंस्कृती मंच</span>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><button onClick={() => window.location.href='/storytelling'} className="hover:text-amber-300 transition duration-150">🤖 AI Stories</button></li>
              <li><button onClick={() => window.location.href='/contribution'} className="hover:text-amber-300 transition duration-150">🌐 Community Hub</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm mb-6">
              <li className="flex items-center">
                ...
                <a href="mailto:info@maharashtraculture.in" className="hover:text-amber-300 transition duration-150">info@maharashtraculture.in</a>
              </li>
              <li className="flex items-center">
                <span className="mr-2">📞</span>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-4 text-xs text-gray-200">
          <p>© 2026 Maharashtra Cultural AI Platform. All rights reserved.</p>
