...
//     try {
//       const res = await fetch (`${process.env.REACT_APP_NODE_API}/api/auth/register`
//                                {
...
//     try {
//       const res = await fetch (`${process.env.REACT_APP_NODE_API}/api/auth/login`{
...
const NODE_API =
  process.env.REACT_APP_NODE_API || "http://localhost:5000";
